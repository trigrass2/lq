	...
	Ew.table('.demoTable',{
		btnValues:[{
			btnId:'btnExport',text:'导出',isTrue:true,selMinNum:1,onClick:function(){
				...
				var sn = $('#text31').val();
				var offlineType = $('#combo33').val();
				var productStartDate = $('#day30').val();
				var productEndDate = $('#day31').val();
				window.top.location.href= apiUrl +'/pcontrol/offline/export?tmBasPlantId='+tmBasPlantId+'&tmBasPartId='+tmBasPartId+'&orderNo='+orderNo +'&offlineType='+offlineType+'&tmBasUlocId='+tmBasUlocId+'&sn='+sn+'&productStartDate='+productStartDate+'&productEndDate='+productEndDate;
			}
		}
  ],
		tableId:'table1',
