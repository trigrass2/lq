	...
	Ew.table('.demoTable',{
		btnValues:[{
			btnId:'btnExport',text:'导出',isTrue:true,selMinNum:1,onClick:function(){
				...
				window.top.location.href= apiUrl +'/pcontrol/manufacturing/export?tmBasPlantId='+tmBasPlantId+'&tmBasPartId='+tmBasPartId+'&orderNo='+orderNo +'&tmBasUlocId='+tmBasUlocId+'&sn='+sn+'&productStartDate='+productStartDate+'&productEndDate='+productEndDate;	
			}
		}
  ],
		tableId:'table1',
