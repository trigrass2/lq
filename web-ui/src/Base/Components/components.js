...
/* 1、单一工厂 */      dorpList('singleTmPlantId',urlPlant,"","tmBasPlantId","plantNo","nameCnS");





/* 2、工厂+车间 */     dorpList('tmPlantIdOfPlantAndWorkShop',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
/* 2、工厂+车间 */     dorpList('tmWorkshopIdOfPlantAndWorkShop',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShop").val(),"tmBasWorkshopId","workshopNo","nameCn");


/* 3、工厂+车间+产线 */     dorpList('tmPlantIdOfPlantAndWorkShopAndLine',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
/* 3、工厂+车间+产线 */     dorpList('tmWorkshopIdOfPlantAndWorkShopAndLine',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShopAndLine").val(),"tmBasWorkshopId","workshopNo","nameCn");
/* 3、工厂+车间+产线 */     dorpList('tmLineIdOfPlantAndWorkShopAndLine',urlLine,'wTmBasWorkshopId:'+$("#tmWorkshopIdOfPlantAndWorkShopAndLine").val(),"tmBasLineId","lineNo","nameCn");



/* 4、工厂+车间+工位 */    dorpList('tmPlantIdOfPlantAndWorkShopAndUloc',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
/* 4、工厂+车间+工位 */    dorpList('tmWorkshopIdOfPlantAndWorkShopAndUloc',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShopAndUloc").val(),"tmBasWorkshopId","workshopNo","nameCn");
...
/* 5、工厂+车间+产线+工位 */    dorpList('tmPlantIdOfPlantAndWorkShopAndLineAndUloc',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
/* 5、工厂+车间+产线+工位 */    dorpList('tmWorkshopIdOfPlantAndWorkShopAndLineAndUloc',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShopAndLineAndUloc").val(),"tmBasWorkshopId","workshopNo","nameCn");
/* 5、工厂+车间+产线+工位 */    dorpList('tmLineIdOfPlantAndWorkShopAndLineAndUloc',urlLine,'wTmBasWorkshopId:'+$("#tmWorkshopIdOfPlantAndWorkShopAndLineAndUloc").val(),"tmBasLineId","lineNo","nameCn");
...
/* 5、工厂+车间+产线+工位 */	 var datas1={
 ...
 /* 6、单一仓库 */            dorpList('singleTmStorageId',urlStorage,"","tmStorageId","storageNo","name"); 
 
 /* 7、仓库+库区 */     dorpList('tmStorageIdOfStorageAndAread',urlStorage,"","tmBasStorageId","storageNo","name");
 /* 7、仓库+库区 */     dorpList('tmAreadIdOfStorageAndAread',urlAread,null,"tmBasStorageId","storageNo","name");
 
 
 /* 8、仓库+库区+库位 */     dorpList('tmStorageIdOfStorageAndAreadAndLoc',urlStorage,"","tmBasStorageId","storageNo","name");
 /* 8、仓库+库区 +库位*/     dorpList('tmAreadIdOfStorageAndAreadAndLoc',urlAread,null,"tmBasStorageId","storageNo","name");
					 var datas2={
 ...
 /* 11、工厂+包装 */    dorpList('tmPlantIdOfPlantAndPackage',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
 /* 11、工厂+包装 */			var datas3={
 ...
 /* 15、工厂+物料 */    dorpList('tmPlantIdOfPlantAndPart',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
 /* 15、工厂+物料 */			var datas4={
 							"tmPlantId":$("#tmPlantIdOfPlantAndPart").val()
 							};
 					initAutoComplete('part',urlPart,datas4,"tmBasPartId","partNo","nameCn");
 					 
 /* 16、工厂+产品*/    dorpList('tmPlantIdOfPlantAndProduct',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
  /* 16、工厂+产品 */			var datas5={
 					 				"tmPlantId":$("#tmPlantIdOfPlantAndProduct").val()
 					 				};
 					 initAutoComplete('product',urlProduct,datas5,"tmBasPartId","partNo","nameCn"); 
/* 17、工厂+产品组*/   	 dorpList('tmPlantIdOfPlantAndPartgroup',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
...
/* 18、工厂+产品组+工产品 */    dorpList('tmPlantIdOfPlantAndPartgroupAndPart',urlPlant,"","tmBasPlantId","plantNo","nameCnS");

/* 18、工厂+产品组+工产品 */    dorpList('tmPartgroupIdOfPlantAndPartgroupAndPart',urlPartgroup,'tmBasPlantId:'+$("#tmPlantIdOfPlantAndPartgroupAndPart").val(),"tmBasPartgroupId","partgroupNo","name");
/* 18、工厂+产品组+工产品 */	 var datas7={"tmBasPlantId":$("#tmPlantIdOfPlantAndPartgroupAndPart").val(),
 ...
 /* 19、工厂+Bom*/    dorpList('tmPlantIdOfPlantAndBOM',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
 ...
 /* 20、工厂+工艺路径*/    dorpList('tmPlantIdOfPlantAndRoute',urlPlant,"","tmBasPlantId","plantNo","nameCnS");
...
/*21、数据词典*/     dorpList('codeList',urlCodeList,"no:"+"PACKAGE_TYPE","tsSysCodeListId","no","name");					 					 
...
/* 2、工厂+车间 */		$("#tmPlantIdOfPlantAndWorkShop").change(function(){
						...
						dorpList('tmWorkshopIdOfPlantAndWorkShop',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShop").val(),"tmBasWorkshopId","workshopNo","nameCn");
					});
...
/* 3、工厂+车间+产线 */	$("#tmPlantIdOfPlantAndWorkShopAndLine").change(function(){
					...
					dorpList('tmWorkshopIdOfPlantAndWorkShopAndLine',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShopAndLine").val(),"tmBasWorkshopId","workshopNo","nameCn");
					dorpList('tmLineIdOfPlantAndWorkShopAndLine',apiUrl + "/base/line/queryLineSelectByPlantId",'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShopAndLine").val(),"tmBasLineId","lineNo","nameCn");
...
/* 3、工厂+车间+产线 */	$("#tmWorkshopIdOfPlantAndWorkShopAndLine").change(function(){
					...
					if($("#tmWorkshopIdOfPlantAndWorkShopAndLine").val()==""||$("#tmWorkshopIdOfPlantAndWorkShopAndLine").val()==null){
						...
						dorpList('tmLineIdOfPlantAndWorkShopAndLine',urlLine,'wTmBasWorkshopId:'+$("#tmWorkshopIdOfPlantAndWorkShopAndLine").val(),"tmBasLineId","lineNo","nameCn");
					}
					});
/* 4、工厂+车间+工位 */	$("#tmPlantIdOfPlantAndWorkShopAndUloc").change(function(){
					...
					dorpList('tmWorkshopIdOfPlantAndWorkShopAndUloc',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShopAndUloc").val(),"tmBasWorkshopId","workshopNo","nameCn");
...
/* 5、工厂+车间+产线+工位 */ 	$("#tmPlantIdOfPlantAndWorkShopAndLineAndUloc").change(function(){
						...
						dorpList('tmWorkshopIdOfPlantAndWorkShopAndLineAndUloc',urlWorkshop,'pTmBasPlantId:'+$("#tmPlantIdOfPlantAndWorkShopAndLineAndUloc").val(),"tmBasWorkshopId","workshopNo","nameCn");
						dorpList('tmLineIdOfPlantAndWorkShopAndLineAndUloc',urlLine,'wTmBasWorkshopId:'+$("#tmWorkshopIdOfPlantAndWorkShopAndLineAndUloc").val(),"tmBasLineId","lineNo","nameCn");
...
/* 7、仓库+库区 */		$("#tmStorageIdOfStorageAndAread").change(function(){
					if($("#tmStorageIdOfStorageAndAread").val()!=null){
		                ...
		                dorpList('tmAreadIdOfStorageAndAread',urlAreadByParentId+"/"+$("#tmStorageIdOfStorageAndAread").val(),null,"tmBasStorageId","storageNo","name");
					}else{
						$("#tmAreadIdOfStorageAndAread").val("");
		                dorpList('tmAreadIdOfStorageAndAread',urlAread,null,"tmBasStorageId","storageNo","name");
					}
					});
/* 8、仓库+库区+库位 */		$("#tmStorageIdOfStorageAndAreadAndLoc").change(function(){
						if($("#tmStorageIdOfStorageAndAreadAndLoc").val()!=null){
							...
							dorpList('tmAreadIdOfStorageAndAreadAndLoc',urlAreadByParentId+"/"+$("#tmStorageIdOfStorageAndAreadAndLoc").val(),null,"tmBasStorageId","storageNo","name");
							...
							$("#tmAreadIdOfStorageAndAread").val("");
							$('#tmLocIdOfStorageAndAreadAndLoc').val('');
							dorpList('tmAreadIdOfStorageAndAreadAndLoc',urlAread,null,"tmBasStorageId","storageNo","name");
							$('#tmLocIdOfStorageAndAreadAndLoc').autocomplete( "destroy" );
							var datas={
							 		 "storage":$("#tmStorageIdOfStorageAndAreadAndLoc").val(),
									 "area":$("#tmAreadIdOfStorageAndAreadAndLoc").val()
...
/* 18、工厂+产品组+产品 */	$("#tmPlantIdOfPlantAndPartgroupAndPart").change(function(){
					...
					$("#tmPartIdOfPlantAndPartgroupAndPart").val("");
					 dorpList('tmPartgroupIdOfPlantAndPartgroupAndPart',urlPartgroup,'tmBasPlantId:'+$("#tmPlantIdOfPlantAndPartgroupAndPart").val(),"tmBasPartgroupId","partgroupNo","name");
...
/* 20、工厂+工艺路径*/      $('#route').keyup(event,function () {
					...
					// 初始化下拉框
					function dorpList(selectId,url,where,resultId,no,name){
						var datas=null;
						if(where && where != null){
						                    ...
						                    $.ajax({
						                        ...
						                        success: function(data) {
						                            response($.map(data.results, function(item) {
						                                return { label: item[no]+"-"+item[name], value:item[name],id: item[resultId] }
						                            }));
						                        }
						                    });
						                },
...
// return row[name];
// //return "<table width='200px'><tr><td align='center'>" + row[no] + "-" +
// row[name] "</td></td></tr></table>";
// },
...
// }
// });
						// new AutoComplete({id:id,url:url,data:datas});
// if (datas != null) {
// $('#'+id).bsSuggest({
// data:datas,
// effectiveFields:[no,name],
// effectiveFieldsAlias:{no:'编号',name:'姓名'},
// showHeader:true,
...
// $('#'+id).val(data[resultId]);
// });
// }
					// $( "#birds" ).autocomplete("destroy"); $( ".selector"
					// ).autocomplete( "destroy" );
// $( "#birds" ).autocomplete({
// source: url,
// minLength: 2,
// response: function( event, ui ) {
// var array=ui.content;
// ui.content=[];
// $.map(array[3], function(item) {
// return { label: item.ulocNo+"-"+item.name, value: item.tmBasUlocId };
//                              
// })
//                         
// },
