...
$(function () {
    ...
    Ew.getDictVal(['ORDER_TYPE', 'ORDER_SOURCE', 'YESORNO'], function (re) {
    var colModel = [{
        label: "ttPpOrderId",
        name: "ttPpOrderId",
        index: "ttPpOrderId",
...
$(function(){
    ...
    Ew.search('.demoSearch2',{
        ...
        btnValues:[{
            btnId:'btnScheduling',text:'排产',onClick:function(){
                ...
                if((planDate != '' && planDate != undefined) && (tmBasRouteId != '' && tmBasRouteId != undefined)) {
                    ...
                    $.when(Ew.ewAjax('/base/pporderseq/addSeqs',JSON.stringify(schedulingData))).done(function(results){
                        if (results) {
