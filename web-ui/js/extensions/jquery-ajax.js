(function ($) {
    ...
    $.ajax = function (options) {
        ...
        var _options = $.extend(options, {
            error: function (XMLHttpRequest, textStatus) {
                if (XMLHttpRequest.status != 200 && XMLHttpRequest.status != 0 && XMLHttpRequest.status != 400 && XMLHttpRequest.status != 404 && XMLHttpRequest.status != 409 && XMLHttpRequest.status != 401) {
