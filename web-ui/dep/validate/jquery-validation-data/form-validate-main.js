...
//检测是否为空
jQuery.validator.addMethod("isStrNull", function(value, element) {
    var strNull = /^[.\n]+$/;
    return this.optional(element) || (strNull.test(value));
}, "必填项不能为空");
//检测手机号是否正确
...
$().ready(function () {
    ...
    var $globalForm1=$('form[id^="globalFormOther"]');
    $globalForm1.validate(validateList);
    var $globalForm2=$('form[id^="globalFormOther2"]');
    $globalForm2.validate(validateList);
    var $globalForm3=$('form[id^="globalFormOther3"]');
